...
{
    /// <inheritdoc />
    public partial class AddIdentityPhase1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false, defaultValue: ""),
                    ...
                    OrganizationScope = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    PasswordMustChange = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceType = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
                    ResourceId = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    SessionId = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    UserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true),
                    RefreshTokenHash = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Status_Email",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditEvents_ActorId_TimestampUtc",
                table: "AuditEvents",
                columns: new[] { "ActorId", "TimestampUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_AuditEvents_TimestampUtc_Action",
                table: "AuditEvents",
                columns: new[] { "TimestampUtc", "Action" });
